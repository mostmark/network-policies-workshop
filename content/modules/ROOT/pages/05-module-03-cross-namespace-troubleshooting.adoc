...
----
oc new-project backend-team-%OPENSHIFT_USERNAME%
----
...
[source,bash,role=execute]
----
oc new-project frontend-team-%OPENSHIFT_USERNAME%
----
...
. Label the frontend-team-{OPENSHIFT_USERNAME} namespace:
+
[source,bash,role=execute]
----
oc label namespace frontend-team-%OPENSHIFT_USERNAME% team=frontend
----
+
Expected output:
+
----
namespace/frontend-team-%OPENSHIFT_USERNAME% labeled
----
