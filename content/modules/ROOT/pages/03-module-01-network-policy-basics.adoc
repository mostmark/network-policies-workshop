...
Just like you created the deny-all policy, you'll use the OpenShift console's *Form view* to create this selective allow policy. The console provides helpful features that let you preview which pods are affected by each part of the policy.
