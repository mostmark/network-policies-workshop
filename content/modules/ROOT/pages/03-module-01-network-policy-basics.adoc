...
. First, log in to the OpenShift cluster and verify your access:
+
...
+
// TODO: Add screenshot of NetworkPolicies list page
...
--
+
// TODO: Add screenshot of the Form view with deny-all configuration
// image::console-networkpolicy-form.png[NetworkPolicy form view showing deny-all configuration]
...
// TODO: Add screenshot of the YAML view
...
Run the following to confirm the deny-all policy is working:
