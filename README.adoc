...
Preview the lab guide https://mostmark.github.io/network-policies-workshop?OPENSHIFT_USERNAME=user1&OPENSHIFT_PASSWORD=mypassword&OPENSHIFT_CONSOLE_URL=https://console-openshift-console.apps.lab.mycluster.com&OPENSHIFT_API_URL=https://api.lab.mycluster.com:6443[here^] 
